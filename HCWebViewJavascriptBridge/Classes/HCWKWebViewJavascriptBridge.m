...
@implementation HCWKWebViewJavascriptBridge {
    __weak WKWebView* _webView;
    __weak id<WKNavigationDelegate> _webViewDelegate;
    long _uniqueId;
    HCWebViewJavascriptBridgeBase *_base;
}

/* API
 *****/

+ (void)enableLogging { [HCWebViewJavascriptBridgeBase enableLogging]; }

+ (instancetype)bridgeForWebView:(WKWebView*)webView {
    HCWKWebViewJavascriptBridge* bridge = [[self alloc] init];
...
- (void) _setupInstance:(WKWebView*)webView {
    ...
    _base = [[HCWebViewJavascriptBridgeBase alloc] init];
    _base.delegate = self;
}
